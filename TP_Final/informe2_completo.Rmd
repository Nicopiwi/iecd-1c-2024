...
Demostraremos que el predictor derivado del estimador de Nadaraya-Watson de la esperanza condicional $Y_i$ = E($Y$ | $X$ = $X_i$), 1 $\leq$ i $\leq$ n de la forma \[\boldsymbol{\hat{Y}} = \begin{pmatrix}
...
smooth_nw_opt <- nwsmooth(x, X, Y, optimal_bandwidth_nw)
plot(X, Y,
     main = "Nadaraya-Watson vs linearsmooth con h = 40",
     xlab = "Circunferencia de la cadera (mm)",
     ylab = "Longitud del glúteo a la rodilla (mm)"
)
