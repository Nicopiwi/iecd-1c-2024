...
```
El método que mejor score R^2 tuvo es el enfoque no paramétrico con el estimador de Nadaraya Watson implementado manualmente. Sin embargo, hay que tener en consideración las observaciones previas.
